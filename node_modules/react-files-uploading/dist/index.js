...
var ReactFileUploading = function (_a) {
    var _b = _a.value, value = _b === void 0 ? [] : _b, onChange = _a.onChange, onError = _a.onError, children = _a.children, _c = _a.multiple, multiple = _c === void 0 ? false : _c, _d = _a.maxNumber, maxNumber = _d === void 0 ? constants_1.INIT_MAX_NUMBER : _d, acceptType = _a.acceptType, maxFileSize = _a.maxFileSize, _e = _a.inputProps, inputProps = _e === void 0 ? {} : _e;
    var inValue = value || [];
    var inputRef = (0, react_1.useRef)(null);
    var _f = (0, react_1.useState)(constants_1.DEFAULT_NULL_INDEX), keyUpdate = _f[0], setKeyUpdate = _f[1];
    var _g = (0, react_1.useState)(null), errors = _g[0], setErrors = _g[1];
    var _h = (0, react_1.useState)(false), isDragging = _h[0], setIsDragging = _h[1];
    var handleClickInput = (0, react_1.useCallback)(function () { return (0, utils_1.openFileDialog)(inputRef); }, [inputRef]);
    var onFileUpload = (0, react_1.useCallback)(function () {
        setKeyUpdate(constants_1.DEFAULT_NULL_INDEX);
        handleClickInput();
    }, [handleClickInput]);
    var onFileRemoveAll = (0, react_1.useCallback)(function () {
    ...
    var onFileUpdate = function (index) {
        setKeyUpdate(index);
        handleClickInput();
    };
    var validate = function (fileList) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            errorsValidation = (0, validation_1.getErrorValidation)({
                fileList: fileList,
    ...
    var handleChange = function (files) { return __awaiter(void 0, void 0, void 0, function () {
        var fileList, isValidate, updatedFileList, updatedIndexes, firstFile, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var acceptTypeString = (0, react_1.useMemo)(function () { return (0, utils_1.getAcceptTypeString)(acceptType); }, [acceptType]);
...
exports.default = ReactFileUploading;
