                        ...
                        <form onSubmit={submitting}>
                            <label>
                                <div className='names'>
                                    ...
                                    <div className="firstName" style={{ width:"20px"}}>
                                        <input className="first-container"
                                            type="text"
                                    ...
                                    <div className="lastName">
                                        <input className="second-container"
                                            type="text"
                                ...
                                <div className=''>
                                    ...
                                    <select className='gender' name="sex" id="genders" onChange={handleGenderChange}>
                                        <option value="Select gender">Select Gender</option>
                                        {gender.map((gender) => <option value={sex.value}>{sex.label}</option>)}
                                    </select>
            ...
            //  </select> */}
             {/* </div> */}
                        ...
                        <p className="account">Have an account?
                            <a href="/home"><span >   Login   </span> </a> </p>
                    </div>
                </div>
            </div  >
